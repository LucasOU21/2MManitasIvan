          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { 
                ...
                text: 'Armarios, estanterías, muebles de salón, cocinas y más.' 
              },
              { 
                icon: <ShieldCheck size={32} className="text-teal-500" />, 
                title: 'Montadores profesionales', 
                text: 'Contamos con un equipo con experiencia en montaje de marcas como IKEA o Leroy Merlin y en cocinas a medida.' 
              },
              { 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm md:shadow-md">
              <h4 className="font-medium text-teal-700 text-base md:text-lg mb-2">Tu mueble listo sin esfuerzo</h4>
